  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Ask anything about your calendar data. I’ll use AI plus safe server-side tools to inspect the saved MongoDB events and answer from the actual numbers.",
    },
  ]);
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              This chat uses AI with safe server-side tools over your saved
              MongoDB events, so it can answer more naturally and keep context
        ...
        <div className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr]">
          <div className="space-y-4 rounded-[1.75rem] border border-slate-200 bg-[linear-gradient(160deg,rgba(236,254,255,0.95),rgba(255,255,255,0.9))] p-5">
            ...
            <div className="rounded-[1.5rem] border border-dashed border-slate-300 bg-white/80 p-4 text-sm leading-6 text-slate-600">
              ...
              healthy vs not healthy counts, recent events, busy dates, and
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3">
                  <p className="text-xs text-slate-400">
                    {dbConfigured
                      ? "Answers are generated by an AI model using your event data on the server."
